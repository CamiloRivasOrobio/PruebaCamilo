...
namespace Database.Shared.Data
{
    public class LaboratorioClinico : ILaboratorioClinico
    {
        ...
        public PaginacionList<Examen> PaginacionExamenesRealizados(string sortOrder, string searchString, int? pageNumber, int pageSize, int? estado, bool solicitado = false)
        {
