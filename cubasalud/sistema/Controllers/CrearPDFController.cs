...
namespace sistema.Controllers
{
    ...
    public class CrearPdfController : Controller
    {
        ...
        ILaboratorioClinico laboratorioClinico, IPacientes pacientesRepository, ICuentasPorCobrar cuentasPorCobrarRepository)
        {
        ...
        public IActionResult ProductosPdf()
        {

            var producto = _productoRepository.GetListPdf();

            return new ViewAsPdf("ProductosPdf", producto);
        }
        ...
        #region PACIENTES
        public IActionResult CarneVacunacionJovenes(int idPaciente)
        {
            ...
            return new ViewAsPdf("CarneVacunacionJovenes", model);
        }
        public IActionResult PacientesExpedientePDF(int pacienteId)
        {
            var paciente = _pacientesRepository.Get(pacienteId);

            return new ViewAsPdf("PacientesExpedientePDF", paciente);
        }
        ...
        public IActionResult PacientesCompromisoMembresiaPDF(int? pacienteId)
        {
            if (pacienteId == null)
            {
                TempData["Message"] = "Solicitud errónea";
            ...
            {
                TempData["Message"] = "Este paciente no tiene membresía";
                return RedirectToAction("Lista", "Pacientes");
            }

            return new ViewAsPdf("PacientesCompromisoMembresiaPDF", paciente);
        }
        #endregion
    }
