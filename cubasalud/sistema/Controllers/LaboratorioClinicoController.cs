...
namespace sistema.Controllers
{
    ...
    public class LaboratorioClinicoController : Controller
    {
        ...
        public IActionResult EditarDetalleExamen(RealizarExamenLabClinicoViewModel viewModel)
        {
            ...
            var examen = _laboratorioClinico.GetExamenRealizado((int)viewModel.Examen.Id);
        ...
        [HttpPost]
        public async Task<IActionResult> RealizarExamenClinico(RealizarExamenLabClinicoViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> ListaExamenesRealizados(string sortOrder, string buscar, string currentFilter, int? pageNumber)
        {
            if (buscar != null)
            {
                pageNumber = 1;
            ...
            var lista = _laboratorioClinico.PaginacionExamenesRealizados(sortOrder, buscar, pageNumber, 20000, null);
